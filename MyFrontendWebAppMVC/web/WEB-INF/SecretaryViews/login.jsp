        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <form action="<%out.print(path);%>SecretaryLogin" method="POST">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-footer">
                                ...
                                <button type="submit" class="btn btn-primary btn-block" id="ok" name="ok" value="OK">Login In as Secreatry</button>
                                <br>
                                <div class="">
