...
<%
    ...
    if (session.getAttribute("doctor") != null) {
        response.sendRedirect(path+"Doctor");
    }
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <form action="<%out.print(path);%>DoctorLogin" method="POST">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-footer">
                                ...
                                <button type="submit" class="btn btn-primary btn-block" id="ok" name="ok" value="OK">Login In as Doctor</button>
                                <br>
                                <div class="">
                                    <span class="pull-left">New here? <a href="Register">Register</a></span>
                                    <div class="pull-right">
                                        <span>Admin <a href="<%out.print(path);%>Admin">Login</a></span><br>
