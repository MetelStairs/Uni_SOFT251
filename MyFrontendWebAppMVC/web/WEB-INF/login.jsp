<%-- 
    Document   : login
    Created on : Jan 14, 2019, 12:44:06 PM
    Author     : Elis Roberts
--%>
                    ...
                    <form action="<%out.print(path);%>SecretaryLogin" method="POST">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-footer">
                                ...
                                <button type="submit" class="btn btn-primary btn-block" id="ok" name="ok" value="OK">Login In as Secretary</button>
                                <br>
                                <div class="">
                                    <span class="pull-left">Patient? <a href="../login.jsp">Login</a></span>
