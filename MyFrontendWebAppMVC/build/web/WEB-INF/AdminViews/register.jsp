        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <form action="<%out.print(path);%>AdminRegister" method="POST">
                        <div class="panel panel-default">
                            <div class="panel-heading"><h3>Register Admin Account</h3></div>
                            ...
                            <div class="panel-footer">
                                ...
                                <button type="submit" class="btn btn-primary btn-block" id="ok" name="ok" value="OK">Register as Admin</button>
                                <br>
                                <div class="">
                                    <span class="pull-left">Have Account? <a href="<%out.print(path);%>Admin/Login">Login In</a></span>
                                </div>
                                <br>
                            </div>
                        </div>   
