                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 home listing-big">
                                ...
                                <div class="your-review">
                                    <form method="POST" action="AddDoctorReview" id="Review_Form">
                                        ...
                                        <textarea class="form-control" maxlength="250" rows="3" required="" id="review" name="message"></textarea>
                                        ...
                                        <div class="star-rating">
                                            ...
                                            <input type="hidden" name="rate" id="whatever1" class="rating-value" value="1">
                                        </div>
