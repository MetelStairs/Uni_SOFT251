                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <form action="<%out.print(path);%>DeletePatient" method="POST">
                                    <input type="hidden" name="username" value="<%out.print(username);%>"/>
                                    <h2>Are you sure that you want to terminate this patient account <%out.print(username);%></h2>
                                    <button type="submit"  class="btn btn-danger btn-block">Terminate Patient Account</button>
                                </form>
                            </div>
                        </div>
                    </div>
